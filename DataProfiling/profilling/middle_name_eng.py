...
def middle_name_eng(param_dict=None):
    ...
    return {'dmn': 'DMN_MIDDLE_NAME_ENG', 'percent': percent_diff_first_name(percentage, mdata_match_percent)} if percentage > min_conformance_percent else {'dmn': 'DMN_MIDDLE_NAME_ENG', 'percent': 0.0}
