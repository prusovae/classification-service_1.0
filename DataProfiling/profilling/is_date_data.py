...
def is_date_data(param_dict=None):
    ...
    from birth_date import birth_date
    from card_expire_date import expire_date
    ...
    dmn_dict[birth_date(param_dict)['dmn']] = \
        float(birth_date(param_dict)['percent'])
    dmn_dict[expire_date(param_dict)['dmn']] = \
        float(expire_date(param_dict)['percent'])
